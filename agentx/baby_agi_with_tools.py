...
todo_prompt = PromptTemplate.from_template(
    "You are a planner who is an expert at coming up with a todo"
    " list for a given objective. Come up with a todo list for this"
    " objective: {objective}"
)
...
tools = [
    ...
    Tool(
        ...
        description=(
            ...
            " objective to create a todo list for. Output: a todo list for"
            " that objective. Please be very clear what the objective is!"
        ),
    ),
]
